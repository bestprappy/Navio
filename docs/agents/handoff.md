...
- **Remaining council steps:** a battery-along-route chart from `projectTripCharging` data; move `EnergySimulationPanel` to `/research/energy`; the evaluation harness.
