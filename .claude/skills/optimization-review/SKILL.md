...
description: "Review ModEvent code for performance and efficiency issues across Next.js client and Java 25 Spring Boot services, then provide prioritized, low-risk optimization recommendations."
---
...
## ModEvent Optimization Rules To Enforce
